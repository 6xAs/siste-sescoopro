...
<section class="team py-5">
    ...
    <div class="heading-agileinfo">
        <a href="bbb"><button class="btn btn-success" type="button" name="button">Trabalhe conosco</button>
</a>
    </div>
</section>
<!-- //about-team -->
