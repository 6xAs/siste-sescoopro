               ...
               <div class="modal-dialog">
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                           ...
                           <div class="form-group">
                                ...
                                <p>{{ $transparency->title}}</p>
                                 <iframe src="/../document-transparency/{{$transparency->file_01}}" width="550" height="350"></iframe>
                       ...
                       <div class="modal-footer">
                               ...
                               {!! Form::open(['route'=> ['deletartransparency.destroy', $transparency->id],'method'=>'DELETE']) !!}
