                    ...
                    <div class="panel-body">
                        @if(Session::has('message'))
                            <div class="alert alert-success">
                                  ...
                                  {!! Session::get('message') !!}
                                  <a href="{{ route('page-inserir-notice') }}" class="alert-link">Inserir outro Notícia?</a>
                            </div>
                        @endif
                        	...
                        	<div class="row">
                                <!-- Form Edit Banner -->
                                <!-- Form Inserir Banner -->
                                {!! Form::model($notice,['route' =>  ['editnotice.update', $notice->id], 'class' => '','method'=>'PUT','files'=>true]) !!}
                                {{ csrf_field() }}
                                ...
                                {!! Form::close() !!}
                                @include('pages-panel.modal-delete-notice')
