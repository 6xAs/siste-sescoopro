                   ...
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                           ...
                           <div class="form-group">
                                ...
                                <p>{{ $noticeDestaque->title}}</p>
                                <img id="mostra" src="/../images-destaque_notices/{{$noticeDestaque->image_01}}" width="350" height="150" alt="" />
                       ...
                       <div class="modal-footer">
                               ...
                               {!! Form::open(['route'=> ['deletarnoticedestaque.destroy', $noticeDestaque->id],'method'=>'DELETE']) !!}
