            ...
            <div class="panel panel-headline">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('nome_patrimonio', null, ['class' => 'form-control', 'placeholder' => 'Nome patrimônio', 'required' => 'required'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('num_patrimonio', 'Número Patrimônio:* ' ) !!}
                        {!! Form::number('num_patrimonio', null, ['class' => 'form-control', 'placeholder' => 'Descreva o número deste patrimônio', 'required' => 'required'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('marca', 'Marca do Produto(objeto):* ' ) !!}
                        {!! Form::text('marca', null, ['class' => 'form-control', 'placeholder' => 'Descreva a marca do patrimônio', 'required' => 'required'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('num_nota_fiscal', 'Número Nota Fiscal:* ' ) !!}
                        {!! Form::text('num_nota_fiscal', null, ['class' => 'form-control', 'placeholder' => 'Descreva o número da nota fiscal', 'required' => 'required'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('data_compra', 'Data da Compra:* ' ) !!}
                        {!! Form::date('data_compra', null, ['class' => 'form-control', 'placeholder' => 'Data da compra', 'required' => 'required'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('ano_compra', 'Ano da Compra:* ' ) !!}
                        {!! Form::text('ano_compra', null, ['class' => 'form-control', 'placeholder' => 'Ano da compra', 'required' => 'required'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('num_serie', 'Número de Série:* ' ) !!}
                        {!! Form::text('num_serie', null, ['class' => 'form-control', 'placeholder' => 'Número de Série', 'required' => 'required'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('garantia', 'Garantia:* ' ) !!}
                        {!! Form::text('garantia', null, ['class' => 'form-control', 'placeholder' => 'Garantia', 'required' => 'required'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('valor', 'Valor:* ' ) !!}
                        {!! Form::text('valor', null, ['class' => 'form-control', 'placeholder' => 'Valor do Produto', 'required' => 'required'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('situacao', 'Situação: ' ) !!}
                        {!! Form::textarea('situacao', null, ['class' => 'form-control', 'placeholder' => 'Descreva a situação atual do produto'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('usuario', 'Usuário: ' ) !!}
                        {!! Form::text('usuario', null, ['class' => 'form-control', 'placeholder' => 'Descreva o usuário que utiliza este produto'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('setor', 'Setor: ' ) !!}
                        {!! Form::text('setor', null, ['class' => 'form-control', 'placeholder' => 'Descreva o o setor onde este produto se encontra'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('data_baixa', 'Data Baixa: ' ) !!}
                        {!! Form::date('data_baixa', null, ['class' => 'form-control', 'placeholder' => 'Data da baixa'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('empresa', 'Empresa: ' ) !!}
                        {!! Form::text('empresa', null, ['class' => 'form-control', 'placeholder' => 'Descreva a empresa onde o produto foi comprado'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('cnpj', 'CNPJ: ' ) !!}
                        {!! Form::text('cnpj', null, ['class' => 'form-control', 'placeholder' => 'Ex:00.000.000/0001-00'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('fone_empresa', 'Telefone da Empresa: ' ) !!}
                        {!! Form::text('fone_empresa', null, ['class' => 'form-control', 'placeholder' => 'Ex: (00)0000-0000'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('email_empresa', 'Email da Empresa: ' ) !!}
                        {!! Form::text('email_empresa', null, ['class' => 'form-control', 'placeholder' => 'Ex: email@mail.com'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('vendedor', 'Vendedor: ' ) !!}
                        {!! Form::text('vendedor', null, ['class' => 'form-control', 'placeholder' => 'Nome do vendedor que vendeu esse produto'] ) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('rua', 'Rua: ' ) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('description', null, ['class' => 'form-control', 'placeholder' => 'Observações'] ) !!}
                    </div>
