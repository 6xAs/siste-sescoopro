...
<section class="welcome py-5">
    <div class="container py-md-8 mt-md-8">
        <h2 class="heading-agileinfo">Missão e Visão<span></span></h2>
        <span class="w3-line black"></span>
        <div class="row about-tp mt-md-5 pt-5">
            <div class="col-md-12">

                <h4>
                    Missão e Visão de um futuro cooperativista
                ...
                <h2 class="heading-agileinfo">Seus objetivos são:</h2>
                <br>
                <ul>
                    <li>Organizar, administrar e executar o ensino de formação profissional, a promoção social dos empregados de cooperativas, </li>
                </ul>



                <h2 class="heading-agileinfo">Consumo</h2>
                <h4>
                ...
                <h2 class="heading-agileinfo">A MAIS ANTIGA, AINDA EM ATIVIDADE </h2>
                <h4>
                ...
                <h2 class="heading-agileinfo">PRIMEIRO CICLO</h2>
                <h4>
                ...
                <h2 class="heading-agileinfo">MARCO HISTÓRICO </h2>
                <h4>
                ...
                <h2 class="heading-agileinfo">RECONHECIMENTO INTERNACIONAL </h2>
                <h4>
                ...
                <h2 class="heading-agileinfo">REFORÇO PARA A EDUCAÇÃO COOPERATIVISTA  </h2>
                <h4>
                ...
                <h2 class="heading-agileinfo">REPRESENTAÇÃO SINDICAL PARA AS COOPERATIVAS  </h2>
                <h4>
                ...
                <h2 class="heading-agileinfo">O QUE VEM POR AÍ   </h2>
                <h4>
